...
static const char qt_meta_stringdata_BluetoothHandler[] = {
    "BluetoothHandler\0\0deviceDiscovered(QVariantMap)\0"
    "deviceDiscovered(QBluetoothDeviceInfo)\0"
};
...
void BluetoothHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->deviceDiscovered((*reinterpret_cast< QVariantMap(*)>(_a[1]))); break;
...
const QMetaObject BluetoothHandler::staticMetaObject = {
    { &QBluetoothDeviceDiscoveryAgent::staticMetaObject, qt_meta_stringdata_BluetoothHandler,
...
// SIGNAL 0
void BluetoothHandler::deviceDiscovered(QVariantMap _t1)
{
